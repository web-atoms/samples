...
import {AtomControl} from "web-atoms-core/dist/web/controls/AtomControl";
	...
	export default class Insurance extends AtomControl {
		...
		public create(): void {
			...
			this.bind(e3, "text",  [["viewModel","errorBroker"]], false , null );
			...
			e4.itemTemplate = Insurance_itemTemplate_1_7Creator(this);
			...
			this.runAfterInit( () => this.setLocalValue(e5, "eventClick",  () => (this.viewModel).addApplicant() ) );
			...
			this.runAfterInit( () => this.setLocalValue(e9, "eventClick",  () => (this.viewModel).save() ) );
	...
	function Insurance_itemTemplate_1_7Creator(__creator) {
		return class Insurance_itemTemplate_1_7 extends Applicant {
