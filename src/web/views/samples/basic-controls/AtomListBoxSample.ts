...
import {AtomControl} from "web-atoms-core/dist/web/controls/AtomControl";
	...
	export default class AtomListBoxSample extends AtomControl {
		...
		public create(): void {
			...
			e1.itemTemplate = AtomListBoxSample_itemTemplate_1_6Creator(this);
	...
	function AtomListBoxSample_itemTemplate_1_6Creator(__creator) {
		return class AtomListBoxSample_itemTemplate_1_6 extends AtomControl {
