...
import {AtomControl} from "web-atoms-core/dist/web/controls/AtomControl";
	...
	export default class AtomListBoxSample extends AtomControl {
		...
		public create(): void {
			...
			e1.itemTemplate = AtomListBoxSample_itemTemplate_1_8Creator(this);
	...
	function AtomListBoxSample_itemTemplate_1_8Creator(__creator) {
		return class AtomListBoxSample_itemTemplate_1_8 extends AtomControl {
