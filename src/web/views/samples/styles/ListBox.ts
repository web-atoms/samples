...
import {AtomControl} from "web-atoms-core/dist/web/controls/AtomControl";
	...
	export default class ListBox extends AtomControl {
		...
		public create(): void {
			...
			e1.itemTemplate = ListBox_itemTemplate_1_10Creator(this);
			
			this.append(e1);
		}
	}
	
	function ListBox_itemTemplate_1_10Creator(__creator) {
		return class ListBox_itemTemplate_1_10 extends AtomControl {
