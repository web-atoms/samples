...
import {AtomControl} from "web-atoms-core/dist/web/controls/AtomControl";
	...
	export default class MDHost extends AtomGridView {
		...
		public create(): void {
			...
			e3.itemTemplate = MDHost_itemTemplate_1_2Creator(this);
			
			this.append(e3);
		}
	}
	
	function MDHost_itemTemplate_1_2Creator(__creator) {
		return class MDHost_itemTemplate_1_2 extends AtomControl {
