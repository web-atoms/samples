...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "web-atoms-core/dist/App", "web-atoms-core/dist/di/Inject", "web-atoms-core/dist/view-model/AtomViewModel", "../../services/http/MovieService"], factory);
    }
    ...
    var MovieService_1 = require("../../services/http/MovieService");
    var MovieViewModele = /** @class */ (function (_super) {
        __extends(MovieViewModele, _super);
        /**
         ...
         */
        function MovieViewModele(app, movieService) {
         ...
         */
        MovieViewModele.prototype.init = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, this.movieService.getMovies("", "", 0, 10)];
                        case 1:
                            _a.movies = _b.sent();
                            return [2 /*return*/];
                    }
